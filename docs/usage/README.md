...
| [04-configuration.md](04-configuration.md) | YAML/JSON config file format and sections |
| [05-troubleshooting.md](05-troubleshooting.md) | Common errors and recovery steps |

Use [`template.md`](template.md) as the starting point for a new usage guide.
